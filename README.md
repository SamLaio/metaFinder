...
ISBN 查詢會優先用 ISBN 本身與主要書店/出版社/圖書館來源搜尋，包含博客來、Readmoo、三民網路書店、皇冠文化、城邦讀書花園、金石堂、誠品、Anobii、Google Books 與圖書館來源；不會再展開成大量書名/作者或網路小說提示查詢，避免外部搜尋引擎變慢時整批卡住。
...
ISBN 搜尋不會因博客來先命中就停止查找其他來源；若博客來只有規格表或缺少有效簡介，工具會在時間預算內繼續補找 Pubu、Readmoo、誠品等候選，並以 ISBN 精確過濾。Pubu 自站搜尋可能回傳推薦清單，因此直接商品 URL 與公開搜尋命中的 Pubu 商品頁比 Pubu 搜尋頁更可靠。
