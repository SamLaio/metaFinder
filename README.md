...
對三民網路書店商品頁會抽取 ISBN13、出版社、作者、譯者、出版日與簡介；對 Pubu 商品頁會抽取書名、作者、出版社、發行日、語言、ISBN、封面與簡介，並清除 Pubu meta description 開頭的 `出版/Publisher` 與 `作者/Author` 前綴；對 `tdtb.org/library` 館藏頁會抽取作者、出版單位、出版年份與簡介。
